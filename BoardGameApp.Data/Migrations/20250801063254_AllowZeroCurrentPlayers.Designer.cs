...
namespace BoardGameApp.Data.Migrations
{
    ...
    [Migration("20250801063254_AllowZeroCurrentPlayers")]
    partial class AllowZeroCurrentPlayers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BoardGameApp.Data.Models.Manager", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<Guid>("ClubId")
                        .HasColumnType("uniqueidentifier")
                        .HasComment("The club this manager is responsible for");
            ...
            modelBuilder.Entity("BoardGameApp.Data.Models.Manager", b =>
                {
                    b.HasOne("BoardGameApp.Data.Models.Club", "Club")
                        .WithOne()
                        .HasForeignKey("BoardGameApp.Data.Models.Manager", "ClubId")
